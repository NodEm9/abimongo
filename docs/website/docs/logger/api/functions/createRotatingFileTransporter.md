...
> **createRotatingFileTransporter**(`options?`): [`BufferedTransporter`](../classes/BufferedTransporter.md) \| \{ `write`: (`message`) => `Promise`\<`void`\>; \}

Defined in: [transports/rotating.transporter.ts:38](https://github.com/NodEm9/abimongo/blob/f798227fd9c43f8c2647fd11dd772b40a643da1f/packages/logger/src/transports/rotating.transporter.ts#L38)
...
[`BufferedTransporter`](../classes/BufferedTransporter.md) \| \{ `write`: (`message`) => `Promise`\<`void`\>; \}

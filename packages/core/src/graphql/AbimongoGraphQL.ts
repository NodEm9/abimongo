 ...
 * 	// Initialize ApolloServer
  ...
  This setup can be very useful for applications that require real-time data updates,
  multi-tenant architectures, and fine-grained access control based on user roles.

 Using the AbimongoGraphQL class, you can easily create a robust GraphQL API
 that leverages the power of MongoDB and Redis, while ensuring that your data
 is secure and accessible only to authorized users. Testing and extending the
 functionality is straightforward, making it a versatile choice for modern web applications.
  ...
  ***Autogenerated schema vs Custom schema***
  ...
  most organisation prefer to create personal schema structure, Abimongo also takes care
  of such scenario by providing custom methods to the AbimnogoGraphQL class. These methos
  allow you create custom schemas or resolvers as needed by accessing the methods 
  like AbimongoBootstrap.customResolvers() or AbimongoBootstrap.customTypeDefs()
  ...
  * Notices that in the above example, we created an Abimongo instance with AbimongoBootstrapFactory and that works only 
  * when you have use the Abimongo bootstrap CLI to bootstrap your application. That when you can to the 
  * AbimongoBootstrapFactory class which generates a fully configured Abimongo instance for you in an 
  * abimongo.config file. 
  * @see AbimongoBootstrapFactory and AbimongoBootstrap for more details of hpw you can do something like 
  * this `npx abimongo-core  my-app --withMultiTenant --withGraphQL --withRedis etc` to bootstrap your app with
  * all these features. This is an a
  * 
 * 
 */
